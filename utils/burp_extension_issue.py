...
class BurpExtender(IBurpExtender, IHttpListener):
    ...
    def processHttpMessage(self, toolFlag: int, messageIsRequest: bool, messageInfo: IHttpRequestResponse) -> None:
    ...
    def createCustomIssue(self, messageInfo: IHttpRequestResponse, title: str, description: str, severity: str) -> None:
        issue = CustomIssue(messageInfo, title, description, severity)
        self._callbacks.addScanIssue(issue)

class CustomIssue(IScanIssue):
    def __init__(self, messageInfo: IHttpRequestResponse, title: str, description: str, severity: str) -> None:
