...
def check_cachetag_header(url: str, req_main: requests.Response, base_header: list[str]) -> None:
    ...
    for header in base_header:
        ...
        if (
            "cache" in header_lower or
            header_name_lower == "vary" or
            header_name_lower == "age" or
            "access" in header_name_lower or
            "host" in header_lower
        ):
