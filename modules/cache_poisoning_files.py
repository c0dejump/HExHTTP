...
def wcp_import(url, matching_forward, custom_header, req_status, authent):
	...
	req_verify_redirect = requests.get(url, params=params, headers=custom_header, verify=False, auth=authent)
	req_verify_url = requests.get(url_param, headers=custom_header, verify=False, allow_redirects=True, auth=authent)
