...
def get(url): req_p = requests.get(url, verify=False, allow_redirects=False, headers=header, timeout=10); return req_p.status_code, "GET", len(req_p.content), req_p.content
def post(url): req_p = requests.post(url, verify=False, allow_redirects=False, headers=header, timeout=10); return req_p.status_code, "POST", len(req_p.content), req_p.content
def put(url): req_pt = requests.put(url, verify=False, allow_redirects=False, headers=header, timeout=10); return req_pt.status_code, "PUT", len(req_pt.content), req_p.content
def patch(url): req_ptch = requests.patch(url, verify=False, allow_redirects=False, headers=header, timeout=10); return req_ptch.status_code, "PATCH", len(req_ptch.content), req_p.content
def options(url): req_o = requests.options(url, verify=False, allow_redirects=False, headers=header, timeout=10); return req_o.status_code, "OPTIONS", len(req_o.content), req_p.content
def trace(url): req_o = requests.trace(url, verify=False, allow_redirects=False, headers=header, timeout=10); return req_o.status_code, "TRACE", len(req_o.content), req_p.content
